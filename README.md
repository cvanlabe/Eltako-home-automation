...
- **Eltako FAM14**: The powersupply and controller of the EnOcean bus
- **FTS14EM**: The input where the existing wall switches are connected to
- **WNT12**: A 12VDC power supply powering the FTS14EM connections to the wall switches
- **FSR14-4x**: A 4-channel teleruptor to which lights are connected
- **FGW14-USB**: A USB connection to let Home Assistant send and receive messages on the EnOcean RS485 bus
